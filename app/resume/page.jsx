        ...
        >
          ...
          <div className='min-h-[70vh] w-full'>
            ...
            <TabsContent value="experience" className="w-full">
              <div className='flex flex-col gap-[30] text-center xl:center xl-text-left'>
                <h3 className='text-4xl font-bold'>{experience.title}</h3>
                <p className='max-w-[600px] text-white/60 mx-auto xl:max-0'>{experience.description}</p>
            ...
            <div className='flex flex-col gap-[30] text-center xl:center xl-text-left'>
                ...
                <p className='max-w-[600px] text-white/60 mx-auto xl:max-0'>{education.description}</p>
                <ScrollArea className="h-[400px]">
                  <ul className='grid grid-cols-1 lg:grid-cols-2 gap-[30px]'>
